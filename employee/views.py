...
def Validate_Login(request):
	...
	try:
		...
		result = {'result':True,'company':employee.company.pk,
					'employee':employee.pk,'type_employee':employee.type_employee,
					'prefix':resolution.prefix,'nit_company':employee.company.nit,
					'fe':employee.company.fe
				}
		try:
